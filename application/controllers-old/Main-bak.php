...
class Main extends CI_Controller {
    ...
    public function company(){
        ...
        $crud->set_table('company_master')
            ...
            ->columns("name","address","telephone","contact_person","contact_mobile","gst_no","logo")
            ->display_as('name','Name')
            ->display_as('address','Address')
            ->display_as('telephone','Telephone')
            ->display_as('gst_no','PAN No.')
            ->display_as('logo','Logo')
            ->display_as('contact_person','Contact Person')
            ->display_as('contact_mobile','Contact Mobile');

        $crud->fields('name','address','telephone','contact_person','contact_mobile','gst_no','logo');
    ...
    public function vehiclemaster()
    {
        ...
        $crud->set_table('vehicle_master')
            ...
            ->columns("vehicle_no","description","reg_authority","make","model","chasis_no","engine_no","permit_type","purchase_date","sold")
