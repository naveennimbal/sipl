    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav slimscrollsidebar">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="<?php echo site_url('main/uom')?>" class="waves-effect"><i class="fa fa-font fa-fw" aria-hidden="true"></i>UOM</a>
                </li>
                <li>
                ...
                <li>
                    ...
                    <a href="#" class="waves-effect"> <i class="fa fa-th-list" data-icon=""></i>
